...
public class AssignPoSUnitIdToPosRequest {
  ...
  public AssignPoSUnitIdToPosRequest() {
  }

  public AssignPoSUnitIdToPosRequest(String merchantId, String locationId, String posId, String poSUnitId) {
    super();
