...
public class ReservationStartRequest {
  ...
  public ReservationStartRequest(String merchantId, String locationId, String posId, String orderId, String amount,
      String bulkRef, String captureType) {
    super();
  ...
  /**
   * Full = Fixed to always capture full (initial) amount when ReservationCapture is called
   * Partial = Amounts equal to or lower than initial amount sent with ReservationStart is accepted
   * 
   * @return
   */
